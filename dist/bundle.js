...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Settings\": function() { return /* binding */ Settings; }\n/* harmony export */ });\n/* harmony import */ var _data_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../data/data */ \"./js/data/data.js\");\n/* harmony import */ var _helpers_helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/helpers */ \"./js/helpers/helpers.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\n\nvar Settings = /*#__PURE__*/function () {\n  function Settings(el) {\n    _classCallCheck(this, Settings);\n\n    this.el = el;\n    this.overlay = this.el.querySelector('.overlay');\n    this.settingsModal = this.el.querySelector('.modal');\n    this.setObjectToStorage = _helpers_helpers__WEBPACK_IMPORTED_MODULE_1__.setObjectToStorage;\n    this.getObjectFromStorage = _helpers_helpers__WEBPACK_IMPORTED_MODULE_1__.getObjectFromStorage;\n    this.timerTime = document.querySelector('.timer__time');\n    this.settingsColors = Array.from(this.el.querySelectorAll('.modal__color-item'));\n    this.settingsFonts = Array.from(this.el.querySelectorAll('.modal__font-item'));\n    this.settingsTextFields = this.el.querySelectorAll('.modal__time-value');\n    this.defaultSettings = _data_data__WEBPACK_IMPORTED_MODULE_0__.timerConfig;\n    this.userSettings;\n    this.init();\n    this.setActiveClassFontOrColorIcon('.modal__font-item', 'modal__font-item-active');\n    this.setActiveClassFontOrColorIcon('.modal__color-item', 'modal__color-item-active');\n    this.inputValidator();\n    this.setStylesToTimer();\n    this.installSettingsFromStorage();\n  }\n\n  _createClass(Settings, [{\n    key: \"init\",\n    value: function init() {\n      this.el.addEventListener('click', settingsClickHendler.bind(this));\n    }\n  }, {\n    key: \"showSettingsWindow\",\n    value: function showSettingsWindow() {\n      this.overlay.style.zIndex = '10';\n      this.settingsModal.classList.remove('modal-hide');\n    }\n  }, {\n    key: \"hideSettingsWindow\",\n    value: function hideSettingsWindow() {\n      var _this = this;\n\n      this.settingsModal.classList.add('modal-hide');\n      setTimeout(function () {\n        return _this.overlay.style.zIndex = '-1';\n      }, 300);\n    }\n  }, {\n    key: \"getUserSettings\",\n    value: function getUserSettings() {\n      var timerInputsValue = this.getTimerInputValue();\n      var activeFont = this.getFontOrColor('.modal__font-item-active');\n      var activeColor = this.getFontOrColor('.modal__color-item-active');\n      var newSettings = {\n        font: activeFont,\n        color: activeColor,\n        pomodoroTime: timerInputsValue.pomodoroTime,\n        shortBreak: timerInputsValue.shortBreak,\n        longBreak: timerInputsValue.longBreak\n      };\n      this.setObjectToStorage('userSettings', newSettings);\n      return newSettings;\n    }\n  }, {\n    key: \"setActiveClassFontOrColorIcon\",\n    value: function setActiveClassFontOrColorIcon(selector, activeSelector) {\n      var items = document.querySelectorAll(selector);\n      items.forEach(function (fontItem) {\n        fontItem.addEventListener('click', function (event) {\n          items.forEach(function (font) {\n            return font.classList.remove(activeSelector);\n          });\n          event.target.classList.add(activeSelector);\n        });\n      });\n    }\n  }, {\n    key: \"getFontOrColor\",\n    value: function getFontOrColor(activeSelector) {\n      var item = document.querySelector(activeSelector);\n      var result = item.dataset.id;\n      return result;\n    }\n  }, {\n    key: \"changeTimerInputValue\",\n    value: function changeTimerInputValue(target) {\n      var input = target.parentElement.firstElementChild;\n      var currentTime = +input.value;\n\n      if (target.dataset.id === 'increase' && currentTime < 99) {\n        input.value = ++currentTime;\n      }\n\n      if (target.dataset.id === 'reduce' && currentTime > 1) {\n        input.value = --currentTime;\n      }\n    }\n  }, {\n    key: \"getTimerInputValue\",\n    value: function getTimerInputValue() {\n      var inputFields = Array.from(this.el.querySelectorAll('.modal__time-value'));\n      var pomodoro = inputFields.find(function (input) {\n        return input.dataset.name === 'pomodoro';\n      }) || this.defaultSettings.pomodoroTime;\n\n      var _short = inputFields.find(function (input) {\n        return input.dataset.name === 'short break';\n      }) || this.defaultSettings.shortBreak;\n\n      var _long = inputFields.find(function (input) {\n        return input.dataset.name === 'long break';\n      }) || this.defaultSettings.longBreak;\n\n      return {\n        pomodoroTime: pomodoro.value,\n        shortBreak: _short.value,\n        longBreak: _long.value\n      };\n    }\n  }, {\n    key: \"inputValidator\",\n    value: function inputValidator() {\n      var inputs = document.querySelectorAll('.modal__time-value');\n      inputs.forEach(function (input) {\n        input.addEventListener('change', function () {\n          input.value = input.value.replace(/[^\\d.]/g, '');\n\n          if (input.value > 99) {\n            input.value = 99;\n          }\n\n          if (input.value < 1) {\n            input.value = 1;\n          }\n        });\n      });\n    }\n  }, {\n    key: \"setStylesToTimer\",\n    value: function setStylesToTimer() {\n      this.setFont();\n      this.setColor();\n      this.writeTimeToTimer();\n    }\n  }, {\n    key: \"setFont\",\n    value: function setFont() {\n      var settingsFromStorage = this.getObjectFromStorage('userSettings') || this.defaultSettings;\n      var font = settingsFromStorage.font;\n\n      switch (font) {\n        case \"'Kumbh Sans', sans-serif\":\n          this.timerTime.style.letterSpacing = '-5px';\n          this.timerTime.style.lineHeight = '100.59px';\n          break;\n\n        case \"'Roboto Slab', serif\":\n          this.timerTime.style.letterSpacing = '0';\n          this.timerTime.style.lineHeight = '131.88px';\n          break;\n\n        case \"'Space Mono', monospace\":\n          this.timerTime.style.letterSpacing = '-10px';\n          this.timerTime.style.lineHeight = '148.1px';\n          break;\n      }\n\n      document.body.style.fontFamily = font;\n    }\n  }, {\n    key: \"setColor\",\n    value: function setColor() {\n      var currentSettings = this.getObjectFromStorage('userSettings') || this.defaultSettings;\n      var color = currentSettings.color;\n      var activeMenuItem = document.querySelector('.menu__link-active');\n      var progressBar = document.querySelector('.timer__progress-bar');\n      activeMenuItem.style.backgroundColor = color;\n      progressBar.style.stroke = color;\n    }\n  }, {\n    key: \"writeTimeToTimer\",\n    value: function writeTimeToTimer() {\n      var settingsFromStorage = this.getObjectFromStorage('userSettings') || this.defaultSettings;\n      (0,_helpers_helpers__WEBPACK_IMPORTED_MODULE_1__.writeTimerTime)(this.timerTime, settingsFromStorage, this.defaultSettings);\n    }\n  }, {\n    key: \"installSettingsFromStorage\",\n    value: function installSettingsFromStorage() {\n      var settings = this.getObjectFromStorage('userSettings') || this.defaultSettings;\n      var activeColor = this.settingsColors.find(function (color) {\n        return color.dataset.id === settings.color;\n      });\n      var activeFont = this.settingsFonts.find(function (font) {\n        return font.dataset.id === settings.font;\n      });\n      this.settingsColors.forEach(function (color) {\n        return color.classList.remove('modal__color-item-active');\n      });\n      activeColor.classList.add('modal__color-item-active');\n      this.settingsFonts.forEach(function (font) {\n        return font.classList.remove('modal__font-item-active');\n      });\n      activeFont.classList.add('modal__font-item-active');\n      this.settingsTextFields.forEach(function (input) {\n        if (input.dataset.name === 'pomodoro') {\n          input.value = settings.pomodoroTime;\n        } else if (input.dataset.name === 'short break') {\n          input.value = settings.shortBreak;\n        } else {\n          input.value = settings.longBreak;\n        }\n      });\n    }\n  }]);\n\n  return Settings;\n}();\n\nfunction settingsClickHendler(event) {\n  event.preventDefault();\n\n  if (event.target.classList.contains('settings__settings-link')) {\n    this.showSettingsWindow();\n  }\n\n  if (event.target.dataset.id === 'close-settings' || event.target.classList.contains('overlay')) {\n    this.hideSettingsWindow();\n  }\n\n  if (event.target.dataset.id === 'increase' || event.target.dataset.id === 'reduce') {\n    this.changeTimerInputValue(event.target);\n  }\n\n  if (event.target.classList.contains('modal__button')) {\n    this.userSettings = this.getUserSettings();\n    this.getUserSettings();\n    this.hideSettingsWindow();\n    this.setStylesToTimer();\n  }\n}\n\n//# sourceURL=webpack:///./js/components/settings.js?");
...
/*!*************************!*\
  ...
  \*************************/
/*! namespace exports */
/*! export timerConfig [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_require__.r, __webpack_exports__, __webpack_require__.d, __webpack_require__.* */
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"timerConfig\": function() { return /* binding */ timerConfig; }\n/* harmony export */ });\nvar timerConfig = {\n  font: \"'Kumbh Sans', sans-serif\",\n  color: 'rgba(248, 112, 112, 1)',\n  pomodoroTime: 25,\n  shortBreak: 5,\n  longBreak: 15\n};\n\n//# sourceURL=webpack:///./js/data/data.js?");
...
/*! export timerCounter [provided] [no usage info] [missing usage info prevents renaming] */
/*! export writeTimerTime [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_require__.r, __webpack_exports__, __webpack_require__.d, __webpack_require__.* */
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"setItemToStorage\": function() { return /* binding */ setItemToStorage; },\n/* harmony export */   \"getItemFromStorage\": function() { return /* binding */ getItemFromStorage; },\n/* harmony export */   \"setObjectToStorage\": function() { return /* binding */ setObjectToStorage; },\n/* harmony export */   \"getObjectFromStorage\": function() { return /* binding */ getObjectFromStorage; },\n/* harmony export */   \"writeTimerTime\": function() { return /* binding */ writeTimerTime; },\n/* harmony export */   \"timerCounter\": function() { return /* binding */ timerCounter; }\n/* harmony export */ });\nfunction setItemToStorage(key, item) {\n  localStorage.setItem(key, item);\n}\nfunction getItemFromStorage(key) {\n  var item = localStorage.getItem(key);\n  return item;\n}\nfunction setObjectToStorage(key, object) {\n  localStorage.setItem(key, JSON.stringify(object));\n}\nfunction getObjectFromStorage(key) {\n  var item = JSON.parse(localStorage.getItem(key));\n  return item;\n}\n\nfunction correctTime(parameter) {\n  var value = parameter;\n  var result;\n\n  if (value < 10) {\n    result = \"0\".concat(value);\n  } else {\n    result = value;\n  }\n\n  return result;\n}\n\nfunction writeTimerTime(timerValue, userSettings, defaultSettings) {\n  var tabFromStorage = localStorage.getItem('activeMenuItem') || 'pomodoro';\n\n  switch (tabFromStorage) {\n    case 'pomodoro':\n      timerValue.innerHTML = \"\\n        <span class=\\\"timer__minute\\\">\".concat(correctTime(userSettings.pomodoroTime) || correctTime(defaultSettings.pomodoroTime), \"</span>\\n        <span class=\\\"timer__separator\\\">:</span>\\n        <span class=\\\"timer__seconds\\\">00</span>\\n        \");\n      break;\n\n    case 'short break':\n      timerValue.innerHTML = \"\\n        <span class=\\\"timer__minute\\\">\".concat(correctTime(userSettings.shortBreak) || correctTime(defaultSettings.shortBreak), \"</span>\\n        <span class=\\\"timer__separator\\\">:</span>\\n        <span class=\\\"timer__seconds\\\">00</span>    \\n      \");\n      break;\n\n    case 'long break':\n      timerValue.innerHTML = \"\\n        <span class=\\\"timer__minute\\\">\".concat(correctTime(userSettings.longBreak) || correctTime(defaultSettings.longBreak), \"</span>\\n        <span class=\\\"timer__separator\\\">:</span>\\n        <span class=\\\"timer__seconds\\\">00</span>    \\n        \");\n  }\n}\nvar timerCounter;\n\n//# sourceURL=webpack:///./js/helpers/helpers.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"images/arrow-bottom.svg\");\n\n//# sourceURL=webpack:///./images/arrow-bottom.svg?");

/***/ }),

/***/ "./images/arrow-top.svg":
/*!******************************!*\
  !*** ./images/arrow-top.svg ***!
  \******************************/
/*! namespace exports */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"images/arrow-top.svg\");\n\n//# sourceURL=webpack:///./images/arrow-top.svg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"images/checked.svg\");\n\n//# sourceURL=webpack:///./images/checked.svg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"images/settings-active.svg\");\n\n//# sourceURL=webpack:///./images/settings-active.svg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"images/settings.svg\");\n\n//# sourceURL=webpack:///./images/settings.svg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"sound/timer-end.mp3\");\n\n//# sourceURL=webpack:///./sound/timer-end.mp3?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack:///./styles/settings.scss?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack:///./styles/timer.scss?");
...
eval("var map = {\n\t\"./timer-end.mp3\": \"./sound/timer-end.mp3\"\n};\n\n\nfunction webpackContext(req) {\n\tvar id = webpackContextResolve(req);\n\treturn __webpack_require__(id);\n}\nfunction webpackContextResolve(req) {\n\tif(!__webpack_require__.o(map, req)) {\n\t\tvar e = new Error(\"Cannot find module '\" + req + \"'\");\n\t\te.code = 'MODULE_NOT_FOUND';\n\t\tthrow e;\n\t}\n\treturn map[req];\n}\nwebpackContext.keys = function webpackContextKeys() {\n\treturn Object.keys(map);\n};\nwebpackContext.resolve = webpackContextResolve;\nmodule.exports = webpackContext;\nwebpackContext.id = \"./sound sync recursive \\\\.(mp3)$\";\n\n//# sourceURL=webpack:///./sound/_sync_\\.(mp3)$?");
